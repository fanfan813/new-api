...
/**
 * YcMultiSelect — tags/chips style multi-select built on Base UI Combobox.
 *
 * Behaviour:
 ...
 */
export function YcMultiSelect(props: YcMultiSelectProps) {
        ...
        <ComboboxList>
          <ComboboxCollection>
            {(item: string) => {
              ...
              } else if (props.renderOption && option) {
                content = props.renderOption(option)
              } else {
